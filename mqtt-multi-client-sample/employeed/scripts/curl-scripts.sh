...
execute  "-X POST -d '${json1}' -H 'Content-Type: application/json' -H 'x-chenile-region-id: US' localhost:8080/empl/op1"

execute "-X GET -H 'Content-Type: application/json' localhost:8080/health-check/emplService"

execute "-X GET -H 'Content-Type: application/json' localhost:8080/service-info/emplService"
