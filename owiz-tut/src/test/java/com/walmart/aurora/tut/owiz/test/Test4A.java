...
public class Test4A extends BaseTest{
	@Test public void testSimple() throws Exception {
		OrchExecutor<BaseContext> oe = obtainOrchExecutor("orch4-a.xml");
		...
		assertInvocationOrder(context,"commandId2","commandId1","commandId3");
	}   
}
