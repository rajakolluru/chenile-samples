...
import org.chenile.query.service.bdd.SpringTestConfig;
...
@SpringBootTest(classes = SpringTestConfig.class,properties = {"spring.profiles.active=unittest"})
...
public class TestStudentQuery {
    ...
    /**
     * @param searchService the searchService to test
     */
